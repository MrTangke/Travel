	  	...
	  	<div class="page-content clearfix">
		    <div id="Member_Ratings">
		     ...
		     <div class="border clearfix">
		       ...
		       <span class="r_f">共<b>${fn:length(listSceneOrder) }</b>个订单记录</span>
		     </div>
		     <!---->
			...
			<tbody>
		       ...
		       <c:forEach items="${listSceneOrder }" var="s" varStatus="sg">
		...
		$.post(
				...
				function(msg){
					if(msg>0){
						...
						if (sgpId >0) {
							location.href = "<%=basePath%>lasterOrder/selectOrderByGroupSceneList?sgpId="+sgpId ;
						}else{
