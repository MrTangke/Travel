...
<body>
	<div id="add_administrator_style" class="add_menber">
		    <form action="<%=basePath %>lastercate/insertCate" method="post" id="formSceneAdd"  style="margin-left:20%" enctype="multipart/form-data" >
		    	<%-- <input type="hidden" name="sgpId" value="${sgpId }"> --%>
				<div class="form-group">
					<label class="form-label"><span class="c-red">*</span>店铺名称：</label>
					<div class="formControls">
						<input type="text" class="input-text" value="" placeholder="请输入店铺名称" name="cateShopname" style="width:250px;" datatype="*" nullmsg="美食店铺名称不能为空">
					</div>
				...
				<div class="form-group">
					...
					<div class="formControls">
					<input type="text" placeholder="请输入店铺地址" name="cateAddress"  value="" style="width:250px;" class="input-text">
					</div>
				...
				<div class="form-group">
					...
					<div class="formControls">
						<textarea cols="" rows="" name="cateMessage" class="textarea" placeholder="店铺简介...300个字符以内" dragonfly="true" style="width:250px;border:1px solid #d5d5d5"></textarea>
				...
				<div class="form-group">x
					...
					<div class="formControls ">
						<input type="text" class="input-text" value="" placeholder="输入联系方式" name="cateTel" style="width:250px;" datatype="*" nullmsg="电话不能为空">
					</div>
					<div class="col-4"> <span class="Validform_checktip"></span></div>
				</div>
				<div class="form-group">
		       ...
		       <!--  <input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;新增&nbsp;&nbsp;" style="margin-left:160px" onclick="sceneAdd()" > -->
		        <input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;美食店铺新增&nbsp;&nbsp;" style="margin-left:160px">
			</form>
		   </div>
		 </div>
</body>
