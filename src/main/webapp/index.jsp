...
<body>
    <div id="bg_wrap">
        <div><img src="<%=basePath%>styles/loginbackground/images/001.jpg" width="100%" height="100%"></div>
        <div><img src="<%=basePath%>styles/loginbackground/images/2.jpg" width="100%" height="100%"></div>
        <div><img src="<%=basePath%>styles/loginbackground/images/3.jpg" width="100%" height="100%"></div>
    </div>
    <div id="Login">
